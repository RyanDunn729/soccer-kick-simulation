...
n = 20; % number of grid points used to generate defender's surface
switch defender_num
    case 1
        % Location of the center of the ellipsoid
        % Translate the ellipsoid up down in time to simulate jump
        XC = -10; YC = 43.5; ZC = 0.9 + 0.7*sin(0.5*pi/0.8*time);
        % Radii of the ellipsoid
        XR = 0.4; YR = 0.4; ZR = 0.9;
    case 2
        XC = -9; YC = 43.5; ZC = 0.85 + 0.5*sin(0.5*pi/0.8*time);
        XR = 0.4; YR = 0.4; ZR = 0.85;
    case 3
        XC = -8; YC = 43.5; ZC = 0.85 + 0.6*sin(0.5*pi/0.8*time);
        XR = 0.4; YR = 0.4; ZR = 0.85;
    case 4
        XC = -7; YC = 43.5; ZC = 0.91 + 0.75*sin(0.5*pi/0.8*time);
